...
This API is part of a CRM Ticket system built with MERN stack.

## How to use

- run `git clone https://github.com/eddieolivas/crm-client-side-api.git`
- run `npm install`
- run `npm start`
...
All the user API routes are as follows `/v1/user/`
...
| 6   | `/v1/user/logout`         | DELETE | Done     | Yes        | Delete user's access to JWT                      |
...
| #   | Routers                        | Verbs | Progress | Is Private | Description                               |
| --- | ------------------------------ | ----- | -------- | ---------- | ----------------------------------------- |
| 1   | `/v1/ticket`                   | GET   | Done     | Yes        | Get all tickets for the logged in in user |
| 2   | `/v1/ticket/{id}`              | GET   | Done     | Yes        | Get a ticket details                      |
| 3   | `/v1/ticket`                   | POST  | Done     | Yes        | Create a new ticket                       |
| 4   | `/v1/ticket/{id}`              | PUT   | Done     | Yes        | Update ticket details i.e. reply message  |
...
| #   | Routers      | Verbs | Progress | Is Private | Description             |
| --- | ------------ | ----- | -------- | ---------- | ----------------------- |
| 1   | `/v1/tokens` | GET   | Done     | No         | Get fresh access to JWT |
